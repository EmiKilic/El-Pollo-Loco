class Character extends MovableObject {
  ...
  triggerBubbleAttack() {
    if (!this.bubbleAttack) {
      ...
      const animationDuration = this.IMAGES_BUBBLE_ATTACK.length * 100; // Duration based on frames
      ...
      setTimeout(() => {
        ...
        this.bubbleAttack_sound.currentTime = 0; // Reset sound to the beginning
        this.playAnimation(this.IMAGES_SWIMMING); // Return to swimming animation
      }, animationDuration); // Play animation for the duration of one cycle
    }
  }
  ...
  triggerSlapAttack() {
    if (!this.slapAttack) {
      ...
      const animationDuration = this.IMAGES_FINSLAP_ATTACK.length * 100; // Duration based on frames
      ...
      setTimeout(() => {
        ...
        this.slapAttack_sound.currentTime = 0; // Reset sound to the beginning
        this.playAnimation(this.IMAGES_SWIMMING); // Return to swimming animation
      }, animationDuration); // Play animation for the duration of one cycle
    }
  }
